...
# Chave da API OpenRouter (se aplicável ao seu projeto)
OPENROUTER_API_KEY = os.getenv('OPENROUTER_API_KEY')

# Chave secreta para segurança do Django.
# IMPORTANTE: Em produção, esta chave deve ser gerada aleatoriamente e mantida em segredo.
# Não use 'sua-chave-secreta-aqui' em produção.
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'sua-chave-secreta-aqui-padrao-dev') 
...
CSRF_TRUSTED_ORIGINS = [
    'http://localhost:8000',
    'http://127.0.0.1:8000',
    'http://localhost:3000', # Adicionado para seu frontend React
    'http://127.0.0.1:3000', # Adicionado para seu frontend React
]

# CORS (Cross-Origin Resource Sharing)
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000', # Seu frontend React
    'http://127.0.0.1:3000', # Seu frontend React
]
...
# Email (configuração para desenvolvimento: imprime emails no console)
